...
At runtime, the application measures its own performance and provides \textbf{performance feedback}, $p_m(t)$, to \SYSTEM{}.
...
iteration, $b(t)$ is the base speed estimate produced by a Kalman
...
\SYSTEM{} meets soft performance goals, even for applications with noisy performance behavior, by adjusting the power cap (and thus actual power consumption):
