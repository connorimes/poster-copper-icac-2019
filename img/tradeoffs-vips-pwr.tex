...
\addplot[thick, solid, color=s1, only marks, mark=square*, mark size=5pt] table[x index=6,y index=4,col sep=comma] {img/tradeoffs/tradeoffs-vips-pwr.csv};
